...
fps = xr.open_dataset(fin + 'psl_Amon_CESM2_piControl_r1i1p1f1_gn_110001-120012.nc')
...
ps = ps.drop({'lon','lat'})
ps = ps.assign_coords(x=lons,y=lats)
ps = ps.rename({'y':'lat','x':'lon'})
...
ps = ps.assign_coords(lon=(ps.lon % 360)).roll(lon=((ps.shape[2] // 2)))
