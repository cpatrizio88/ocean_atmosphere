...
covTQ_sstar = lambdaQ_s*st.cov(sst, Q_sstar)
covTQ_rstar = lambdaQ_r*st.cov(sst, Q_rstar)

#testQ_r_var = Q_rstar_var + lambdaQ_r_var + 2*covTQ_rstar

#covTQ_sstar_test = lambdaQ_s*st.cov(sst, Q_sstar, lagx=0)

#covTQ_rstar_test = lambdaQ_r*st.cov(sst, Q_rstar, lagx=-2)
