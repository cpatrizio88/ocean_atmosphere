...
cov_Qr = st2.cov(sst, Qr, lagx=1)
cov_Qs = st2.cov(sst, Q_s, lagx=1)
...
lognorm=colors.SymLogNorm(linthresh=0.3, linscale=0.3, vmin=vmin, vmax=vmax)
...
mapper(T_var/Tmxl_var_ECCO, logscale=False, bnds=bnds, title='$\sigma^2_{T,OAFlux} / \sigma^2_{T,ECCO}$', cbfrac=cbfrac, units=r'', cmap=fieldcmap, vmin=0.0, vmax=2.0)
...
mapper(sst_var_OAFlux/Tmxl_var_ECCO, logscale=False, bnds=bnds, title='$\sigma^2_{T_s,OAFlux} / \sigma^2_{T,ECCO}$', cbfrac=cbfrac, units=r'', cmap=fieldcmap, vmin=0.0, vmax=2.0)
...
mapper(sst_var_ECCO/Tmxl_var_ECCO, logscale=False, bnds=bnds, title='$\sigma^2_{T_s,ECCO} / \sigma^2_{T,ECCO}$', cbfrac=cbfrac, units=r'', cmap=fieldcmap, vmin=0.0, vmax=2.0)
...
mapper(np.log(sst_var_ECCO/Tmxl_var_ECCO), logscale=False, bnds=bnds, title='$log(\sigma^2_{T_s,ECCO} / \sigma^2_{T,ECCO})$', cbfrac=cbfrac, units=r'', cmap=fieldcmap, vmin=-2.0, vmax=2.0)
