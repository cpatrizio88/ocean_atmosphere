...
if lowpass:
    ...
    sst = st.butter_highpass_filter_xr(sst, cutoff, fs, order)
    thf = st.butter_highpass_filter_xr(thf, cutoff, fs, order)
    Q_net_surf = st.butter_highpass_filter_xr(Q_net_surf, cutoff, fs, order)
