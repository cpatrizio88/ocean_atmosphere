...
fh = xr.open_dataset(fin + 'ecco_MXLDEPTH.nc')
...
#EN4
fin = '/Users/cpatrizio/data/EN4/'
fT = xr.open_dataset(fin + 'EN4_T_1980to2018.nc')
...
h = regridder(h)  # print basic regridder information.
...
##sst = theta.isel(k=0)
#
T_mxl = (weights*T).where(mxlpoints).sum(dim='k')
