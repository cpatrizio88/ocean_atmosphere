...
mapper = Mapper()
mapper(var_T_Qs, log=False, logscale=False, bnds=bnds, title=r'$var(T_{Q_s})$', units=r'K$^{2}$', cmap=fieldcmap, vmin=-40, vmax=40)
...
mapper = Mapper()
mapper(var_T_Qo, log=False, logscale=False,  bnds=bnds,  title=r'$var(T_{Q_o})$', units=r'K$^{2}$', cmap=fieldcmap, vmin=-40, vmax=40)
...
mapper = Mapper()
mapper(cov_T_Qs_T_Qo, log=False, logscale=False,  bnds=bnds,  title=r'$cov(T_{Q_s},T_{Q_o})$', units=r'K$^{2}$', cmap=fieldcmap, vmin=-40, vmax=40)
...
mapper = Mapper()
mapper(var_T, bnds=bnds, log=False, logscale=False, title=r'$\sigma^2_T$', units=r'K$^{2}$', cmap=sstcmap, vmin=0, vmax=sstvmax)
plt.savefig(fout + '{:s}_var_T_{:1.0f}LP_{:2.0f}Nto{:2.0f}N_detr{:s}.png'.format(dataname, Tn/12., latbounds[0], latbounds[1], str(detr)[0]))
plt.close()

mapper = Mapper()
mapper(var_T_Qs+cov_T_Qs_T_Qo, log=False, logscale=False, bnds=bnds, title=r'$Q_s$', units=r'K$^{2}$', cmap=fieldcmap, vmin=vmin, vmax=vmax)
...
mapper = Mapper()
mapper(var_T_Qo+cov_T_Qs_T_Qo, log=False, logscale=False, bnds=bnds, title=r'$Q_o$', units=r'K$^{2}$', cmap=fieldcmap, vmin=vmin, vmax=vmax)
...
mapper = Mapper()
mapper(var_T_sum, bnds=bnds, log=False, title=r'SUM', units=r'K$^{2}$', cmap=sstcmap, vmin=0, vmax=sstvmax)
