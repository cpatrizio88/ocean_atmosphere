...
m,ax=mapper(SSTregQo, bnds=bnds, ct=False, cbfrac=cbfrac,title=r'SST and SLP tendency regressed onto $Q_o$', units=r'K/(W m$^{-2}$)', cmap=fieldcmap, vmin=-1e-2,vmax=1e-2)
...
plt.figure(figsize=(12,10))
m,ax=mapper(SSTregQs, bnds=bnds, ct=False, cbfrac=cbfrac,title=r'SST and SLP tendency regressed onto $Q_s$', units=r'K/(W m$^{-2}$)', cmap=fieldcmap, vmin=-1e-2,vmax=1e-2)
ctstep = np.abs(psmax-psmin)/20
ctlevels = np.arange(psmin,psmax+ctstep, ctstep)
...
plt.figure(figsize=(8,6))
m,ax=mapper(SLPregQo, bnds=bnds, ct=True, cbfrac=cbfrac,title=r'SLP regressed onto $Q_o$', units=r'hPa/(W m$^{-2}$)', cmap=fieldcmap, vmin=psmin,vmax=psmax)
ax.add_patch(mpatches.Rectangle(xy=[x1,y1], width=(x2-x1), height=(y2-y1), facecolor='none', edgecolor='black',linewidth=3,transform=cart.crs.PlateCarree()))
#poly = Polygon([(x1,y1),(x2,y1),(x2,y1),(x2,y2)],facecolor='none',edgecolor='black',linewidth=3,zorder=100, transform=cart.crs.PlateCarree())
#ax.add_patch(poly)
plt.savefig(fout + '{:s}_SSTregQo_{:1.0f}LP_{:2.0f}Nto{:2.0f}N_detr{:s}.png'.format(dataname, Tn/12., latbounds[0], latbounds[1], str(detr)[0]))
plt.close()

#plt.figure(figsize=(8,6))
#m,ax=mapper(QsregQo, bnds=bnds, ct=False, cbfrac=0.05,title=r'$Q_s$ regressed onto $Q_o$', units=r'W m$^{-2}$/(W m$^{-2}$)', cmap=fieldcmap, vmin=-1.0,vmax=1.0)
#ax.add_patch(mpatches.Rectangle(xy=[x1,y1], width=(x2-x1), height=(y2-y1), facecolor='none', edgecolor='black',linewidth=3,transform=cart.crs.PlateCarree(), zorder=5))
##poly = Polygon([(x1,y1),(x2,y1),(x2,y1),(x2,y2)],facecolor='none',edgecolor='black',linewidth=3,zorder=100, transform=cart.crs.PlateCarree())
##ax.add_patch(poly)
...
#
#plt.figure(figsize=(8,6))
#m,ax=mapper(SLPregQs, bnds=bnds, ct=True, cbfrac=0.05,title=r'SLP regressed onto $Q_s$', units=r'hPa/(W m$^{-2}$)', cmap=fieldcmap, vmin=psmin,vmax=psmax)
#ax.add_patch(mpatches.Rectangle(xy=[x1,y1], width=(x2-x1), height=(y2-y1), facecolor='none', edgecolor='black',linewidth=3,transform=cart.crs.PlateCarree(), zorder=5))
#plt.savefig(fout + '{:s}_SLPregQs_{:1.0f}LP_{:2.0f}Nto{:2.0f}N_detr{:s}.png'.format(dataname, Tn/12., latbounds[0], latbounds[1], str(detr)[0]))
#plt.close()
#
#
#
#plt.figure(figsize=(8,6))
#m,ax=mapper(SSTregSST, bnds=bnds, ct=False, cbfrac=0.05,title=r'SST regressed onto SST', units=r'K/K', cmap=fieldcmap, vmin=-1.0,vmax=1.0)
#ax.add_patch(mpatches.Rectangle(xy=[x1,y1], width=(x2-x1), height=(y2-y1), facecolor='none', edgecolor='black',linewidth=3,transform=cart.crs.PlateCarree(), zorder=5))
##poly = Polygon([(x1,y1),(x2,y1),(x2,y1),(x2,y2)],facecolor='none',edgecolor='black',linewidth=3,zorder=100, transform=cart.crs.PlateCarree())
##ax.add_patch(poly)
#plt.savefig(fout + '{:s}_SSTregSST_{:1.0f}LP_{:2.0f}Nto{:2.0f}N_detr{:s}.png'.format(dataname, Tn/12., latbounds[0], latbounds[1], str(detr)[0]))
#plt.close()

#plt.figure(figsize=(8,6))
#m,ax=mapper(SSTregtendSST, bnds=bnds, ct=False, cbfrac=0.05,title=r'SST regressed onto SST tendency', units=r'K/(K s$^{-1}$)', cmap=fieldcmap, vmin=-1.0,vmax=1.0)
#ax.add_patch(mpatches.Rectangle(xy=[x1,y1], width=(x2-x1), height=(y2-y1), facecolor='none', edgecolor='black',linewidth=3,transform=cart.crs.PlateCarree()))
##poly = Polygon([(x1,y1),(x2,y1),(x2,y1),(x2,y2)],facecolor='none',edgecolor='black',linewidth=3,zorder=100, transform=cart.crs.PlateCarree())
##ax.add_patch(poly)
#plt.savefig(fout + '{:s}_SSTregSSTtend_{:1.0f}LP_{:2.0f}Nto{:2.0f}N_detr{:s}.png'.format(dataname, Tn/12., latbounds[0], latbounds[1], str(detr)[0]))
#plt.close()
