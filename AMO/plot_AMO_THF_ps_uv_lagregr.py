...
for latbounds in latboundsar:
    ...
    for i in range(nlat):         
         ...
         clf = linear_model.LinearRegression()
         if ltlag > 0:
             clf.fit(AMOstd[ltlag:].reshape(-1,1), uprime_g[:-ltlag,:])
         else:
             clf.fit(AMOstd[:ltlag].reshape(-1,1), uprime_g[-ltlag:,:])
         ...
         clf = linear_model.LinearRegression()
         if ltlag > 0:
             clf.fit(AMOstd_lt[ltlag:].reshape(-1,1), u_lt_g[:-ltlag,:])
         else:
             clf.fit(AMOstd_lt[:ltlag].reshape(-1,1), u_lt_g[-ltlag:,:])
         ...
         clf = linear_model.LinearRegression()
         if ltlag > 0:
             clf.fit(AMOstd[ltlag:].reshape(-1,1), vprime_g[:-ltlag,:])
         else:
             clf.fit(AMOstd[:ltlag].reshape(-1,1), vprime_g[-ltlag:,:])
         ...
         clf = linear_model.LinearRegression()
         if ltlag > 0:
             clf.fit(AMOstd_lt[ltlag:].reshape(-1,1), v_lt_g[:-ltlag,:])
         else:
             clf.fit(AMOstd_lt[:ltlag].reshape(-1,1), v_lt_g[-ltlag:,:])
         ...
         clf = linear_model.LinearRegression()
         if ltlag > 0:
             clf.fit(AMOstd[ltlag:].reshape(-1,1), psprime_g[:-ltlag,:])
         else:
             clf.fit(AMOstd[:ltlag].reshape(-1,1), psprime_g[-ltlag:,:])
         ...
         clf = linear_model.LinearRegression()
         if ltlag > 0:
             clf.fit(AMOstd_lt[ltlag:].reshape(-1,1), ps_lt_g[:-ltlag,:])
         else:
             clf.fit(AMOstd_lt[:ltlag].reshape(-1,1), ps_lt_g[-ltlag:,:])
         ...
         clf = linear_model.LinearRegression()
         if ltlag > 0:
             clf.fit(AMOstd[ltlag:].reshape(-1,1), thfprime_g[:-ltlag,:])
         else: 
             clf.fit(AMOstd[:ltlag].reshape(-1,1), thfprime_g[-ltlag:,:])
         ...
         clf = linear_model.LinearRegression()
         if ltlag > 0:
             clf.fit(AMOstd_lt[ltlag:].reshape(-1,1), thf_lt_g[:-ltlag,:])
         else:
             clf.fit(AMOstd_lt[:ltlag].reshape(-1,1), thf_lt_g[-ltlag:,:])
...
#    ax.set_xlabel('SLP lag (years)')
    ...
    ax.quiver(x[::uskip,::uskip], y[::uskip,::uskip], ucorrs[::uskip,::uskip], vcorrs[::uskip,::uskip], transform=prj, width=0.001, headwidth=16, headlength=10, minshaft=4)
    plt.title(r'regression of SST, SLP and 10-m winds on AMO ({:1.0f}$^{{\circ}}$N to {:2.0f}$^{{\circ}}$N)'.format(latbounds[0], latbounds[1]))
    plt.savefig(fout + '{:s}_AMO_sstSLPuv_lag{:1.0f}corr_map_{:2.0f}Nto{:2.0f}N_detr{:s}.pdf'.format(dataname, -ltlag, latbounds[0], latbounds[1], str(detr)[0]))
    plt.close()
    ...
    cb = plt.colorbar(plot, label=r'$^{{\circ}}$C')
    ax.quiver(x[::uskip,::uskip], y[::uskip,::uskip], ucorrs_lt[::uskip,::uskip], vcorrs_lt[::uskip,::uskip], transform=prj, width=0.001, headwidth=16, headlength=10, minshaft=4)
    ...
    plt.savefig(fout + '{:s}_AMO_sstSLPuv_lag{:1.0f}ltcorr_map_{:2.0f}Nto{:2.0f}N_detr{:s}.pdf'.format(dataname, -ltlag, latbounds[0], latbounds[1], str(detr)[0]))
    plt.close()
    ...
    cb = plt.colorbar(plot, label=r'$^{{\circ}}$C')
    ax.quiver(x[::uskip,::uskip], y[::uskip,::uskip], ucorrs_st[::uskip,::uskip], vcorrs_st[::uskip,::uskip], transform=prj, width=0.001, headwidth=16, headlength=10, minshaft=4)
    ...
    plt.savefig(fout + '{:s}_AMO_thf_lag{:1.0f}corr_map_{:2.0f}Nto{:2.0f}N_detr{:s}.pdf'.format(dataname, -ltlag, latbounds[0], latbounds[1], str(detr)[0]))
    plt.close()
    ...
    plt.savefig(fout + '{:s}_AMO_thf_lag{:1.0f}ltcorr_map_{:2.0f}Nto{:2.0f}N_detr{:s}.pdf'.format(dataname, -ltlag, latbounds[0], latbounds[1], str(detr)[0]))
    plt.close()
