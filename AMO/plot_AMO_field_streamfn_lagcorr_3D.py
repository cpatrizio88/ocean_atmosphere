...
#TODO: get v-component... in order to get stream function, integrate from 0 to p
ctfield = fv3D['V']
...
for latbounds in latboundar:
    ...
    #ax.clabel(ct, fontsize=9, inline=1, fmt='%1.3f')
    h=ax.contourf(tt, pp, fieldanom_na_an.T, 310, levels=fieldlevels, cmap=plt.cm.RdBu_r, extend='both')
    ax.set_ylim(50,1000)
    ax.invert_yaxis()
