...
if plotmaps:
    ...
    for leadi in range(len(lags)):
            ...
            plt.savefig(fout + '{:s}_AMM_{:s}_lag{:1.0f}corr_map_{:2.0f}Nto{:2.0f}N_detr{:s}.pdf'.format(dataname, fsave, lags[leadi], latbounds[0], latbounds[1], str(detr)[0]))
            plt.close()
            ...
            if lterm:
                ...
                plt.savefig(fout + '{:s}_AMM_{:s}_lag{:1.0f}ltcorr_map_{:2.0f}Nto{:2.0f}N_detr{:s}.pdf'.format(dataname, fsave, lags[leadi], latbounds[0], latbounds[1], str(detr)[0]))
                plt.close()
                ...
                plt.savefig(fout + '{:s}_AMM_{:s}_lag{:1.0f}stcorr_map_{:2.0f}Nto{:2.0f}N_detr{:s}.pdf'.format(dataname, fsave, lags[leadi], latbounds[0], latbounds[1], str(detr)[0]))
                plt.close()
